...
class GoogleTextToWavConverter(TextToWavConverter):
    def convert_to_wav(self, text: str, wav_file_path: str) -> bool:
        try:
            ...
            # MP3를 WAV로 변환
            audio = AudioSegment.from_mp3(temp_mp3_path)#위치 갖고옴
            audio = audio.set_frame_rate(16000)#샘플레이트
            audio.export(wav_file_path, format='wav')#변환하여 저장
...
if __name__ == "__main__":
    ...
    text = """안녕하세요! 저의 이름은 라라라마입니다! 잘부탁드려요!."""
